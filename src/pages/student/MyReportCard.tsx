...
import { STUDENTS, CLASSES, TERMS, GRADES, calcGrade, computeGpaSummary, computeAttendanceSummary } from '../../data/mockData';
...
export default function MyReportCard() {
  ...
  // computeGpaSummary returns GpaSummary[] for the whole class — find this student's entry
  const summaries  = computeGpaSummary(student.classId, currentTerm.id);
    ...
    <div>
      ...
      <div className="card" style={{ padding: 32 }}>
        <div ref={printRef}>
          ...
          <div style={{ textAlign: 'center', color: '#94a3b8', fontSize: 13, marginBottom: 16 }}>Student Academic Report Card · {currentTerm.name}</div>
          ...
          <div className="table-wrap" style={{ marginBottom: 20 }}>
            <table>
              <thead><tr><th>Subject</th><th>Score</th><th>Letter Grade</th><th>Grade Points</th><th>Descriptor</th></tr></thead>
              <tbody>
