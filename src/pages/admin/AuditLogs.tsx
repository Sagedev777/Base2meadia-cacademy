...
const DEMO_LOGS: AuditEntry[] = [
  ...
  { id: 'a3',  user: 'Dr. Samuel Osei',  role: 'admin',   action: 'PAYMENT',  module: 'Financials',  details: 'Marked GH₵ 800 as paid for Kwame Asante',   ip: '192.168.1.10', time: '2025-04-16 10:01:48' },
